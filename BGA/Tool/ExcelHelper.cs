...
namespace Tool
{
    ...
    {
        private const string ExcelConnection12= "Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties='Excel 8.0;HDR=YES;IMEX=1';"; // Office 07及以上版本 不能出现多余的空格 而且分号注意
        ...
        public static List<string> GetExcelTableName(string FileNameURL)
        {
            ...
            string strConn = string.Format(ExcelConnection12, FileNameURL);
